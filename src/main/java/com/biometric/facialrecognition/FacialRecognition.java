package com.biometric.facialrecognition;
...
class FacialRecognition
{
    ...
    private static Mat detectFaces(Mat image, CascadeClassifier faceDetector, ImageFrame frame)
    {
        ...
        for (Rect face : faces)
        {
           ...
           // Imgproc.putText(image, "Welcome: " + identifyFace(croppedImage), face.tl(), Font.BOLD, 1.5, color);
...
//        if(faceCount<=0)
//            JOptionPane.showMessageDialog(null, "Face Not Detected.Please try again", "Message", 1);
//        if(faceCount>0)
//        JOptionPane.showMessageDialog(null, "Face Recognized", "Message", 1);
